...
class DCL
{
	...
	static void deleteEnd(){
		...
		if(head.next==head)
		{
			...
			System.out.println("successfully deleted the last and only element "+head.data);

			head=null;
			return;
		}

		Node ptr=head.pre.pre;
		System.out.println("successfully deleted the last element "+ptr.next.data);
		ptr.next.pre=null;
		ptr.next.next=null;
		ptr.next=head;
		head.pre=ptr;
